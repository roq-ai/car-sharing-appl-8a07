...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Car Sharing Application v3`}</title>

        <meta
          name="description"
          content="Welcome to Car Sharing Application v3 - Building Bridges, Not Walls. Your journey towards seamless and sustainable urban mobility starts here."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1605618312848-1c2f4e6fd755?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXIlMjBzaGFyaW5nfGVufDB8fHx8MTY5NjMxMzY3OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Car Sharing Application v3`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Car Sharing Application v3 - Building Bridges, Not Walls. Your journey towards seamless and sustainable urban mobility starts here.`}
            </Text>
            <Box
